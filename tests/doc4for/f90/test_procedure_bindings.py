...
class TestFunctionBindings(TestCase):
    ...
    """
        ...
        self.assertEqual(interface["description"], "Interface for C interoperable function\n")
        self.assertEqual(len(interface["module_procedures"]), 0)
    ...
    """
        ...
        self.assertIsNone(func_without_binding["binding_type"])
