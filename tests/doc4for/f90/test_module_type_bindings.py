...
"""
        ...
        self.assertEqual(regular_impl['binding_type']['type'], BindingTypeEnum.DEFAULT)
        self.assertIsNone(regular_impl['binding_type']['name'])
    ...
    """
        ...
        self.assertEqual(simple_cleanup['binding_type']['type'], BindingTypeEnum.DEFAULT)
    ...
    """
        ...
        self.assertEqual(mixed_f_proc['binding_type']['type'], BindingTypeEnum.DEFAULT)
        self.assertIsNone(mixed_f_proc['binding_type']['name'])
        
        # Check regular interface procedures have no binding
        regular_int_proc = regular_interface['procedures']['regular_int']
        self.assertEqual(regular_int_proc['binding_type']['type'], BindingTypeEnum.DEFAULT)
        
        regular_real_proc = regular_interface['procedures']['regular_real']
        self.assertEqual(regular_real_proc['binding_type']['type'], BindingTypeEnum.DEFAULT)
        ...
        self.assertEqual(mixed_f_impl['binding_type']['type'], BindingTypeEnum.DEFAULT)
